...
public class Expert extends User {
	...
	public Expert( String username, String email, String nomPrenom , String password, 
			String gender, long telephone , String image, LocalDate date_inscription , String role   ) {
	...
	public Expert( String username, String email,String nomPrenom ,  String password, 
			String gender, long telephone , String image, LocalDate date_inscription , String role, AdminMedicalManager admin  ) {
		super(username,email,nomPrenom ,password,image , date_inscription , role );
		this.gender=gender;
		this.telephone=telephone;
		this.admin=admin ; 
