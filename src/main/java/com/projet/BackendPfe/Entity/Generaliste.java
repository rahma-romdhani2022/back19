...
public class Generaliste extends User {
	...
	private List<Consultation>liste1=new ArrayList<Consultation>();
	 ...
	 public Generaliste(String username, String email,String nomPrenom ,  String password, String gender, long telephone ,  String image , LocalDate date_inscription  , String role ,String specialite  ) {
